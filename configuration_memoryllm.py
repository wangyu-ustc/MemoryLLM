...
#             Vocabulary size of the MemoryLLM model. Defines the number of different tokens that can be represented by the
...
#         num_key_value_heads=32,  # If this is different from num_attention_heads, consider how it integrates.
#         num_blocks=30,
#         num_tokens=256,
#         torch_dtype="float32",
...
class MemoryLLMConfig(PretrainedConfig):
    ...
    Args:
        ...
        num_tokens ('int', *optional*, defaults to 256):
            Number of tokens in the memory block.
        num_blocks ('int', *optional*, defaults to 30):
            Number of memory blocks.
        add_bos_embedding ('bool', *optional*, defaults to `True`):
            Whether to add a BOS embedding to the memory tokens.
